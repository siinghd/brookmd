...
fn lib_default_config_json(block_data: bool) -> CString {
    CString::new(format!(
        r#"{{"gfm_autolinks":false,"gfm_alerts":false,"gfm_tagfilter":false,"gfm_footnotes":false,"gfm_math":false,"dir_auto":false,"a11y":false,"unsafe_html":false,"block_data":{block_data},"soft_breaks":false,"lenient_lists":false,"block_html":false}}"#
    ))
