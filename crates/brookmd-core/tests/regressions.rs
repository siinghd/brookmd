...
//! images — each verifying brookmd is correct under both one-shot and
...
/// time on older Safari / iOS WebKit (< 16.3). brookmd's autolinks are written
...
/// escaped parentheses. brookmd renders them to KaTeX-ready markup and keeps
