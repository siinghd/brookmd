...
//! [`BrookSession::new`] (equivalent to `StreamParser::new()`), and
//! [`BrookSession::new_with_config`] with [`lib_default_config`] (every setter at
...
use brook_md_ffi::{BrookConfig, BrookSession};
...
const OFF_APPEND_2: &str = r#"{"newly_committed":[],"active":[{"id":3,"kind":{"type":"Table"},"start":46,"end":76,"html":"<table>\n<thead>\n<tr>\n<th>A</th>\n<th>B</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td>1</td>\n<td>2</td>\n</tr>\n</tbody>\n</table>","open":true,"speculative":true}]}"#;
const OFF_FINALIZE: &str = r#"{"newly_committed":[{"id":3,"kind":{"type":"Table"},"start":46,"end":76,"html":"<table>\n<thead>\n<tr>\n<th>A</th>\n<th>B</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td>1</td>\n<td>2</td>\n</tr>\n</tbody>\n</table>","open":false,"speculative":false}],"active":[]}"#;
const OFF_ALLBLOCKS: &str = r#"[{"id":0,"kind":{"type":"Heading","data":1},"start":0,"end":8,"html":"<h1>Title</h1>","open":false,"speculative":false},{"id":1,"kind":{"type":"Paragraph"},"start":9,"end":21,"html":"<p>Hello world</p>","open":false,"speculative":false},{"id":2,"kind":{"type":"CodeBlock","data":{"lang":"rust"}},"start":22,"end":45,"html":"<pre><code class=\"language-rust\" data-lang=\"rust\">let x = 1;\n</code></pre>","open":false,"speculative":false},{"id":3,"kind":{"type":"Table"},"start":46,"end":76,"html":"<table>\n<thead>\n<tr>\n<th>A</th>\n<th>B</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td>1</td>\n<td>2</td>\n</tr>\n</tbody>\n</table>","open":false,"speculative":false}]"#;
...
const ON_APPEND_2: &str = r#"{"newly_committed":[],"active":[{"id":3,"kind":{"type":"Table","data":{"headers":[{"text":"A","html":"A"},{"text":"B","html":"B"}],"rows":[[{"text":"1","html":"1"},{"text":"2","html":"2"}]],"aligns":[null,null]}},"start":46,"end":76,"html":"<table>\n<thead>\n<tr>\n<th>A</th>\n<th>B</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td>1</td>\n<td>2</td>\n</tr>\n</tbody>\n</table>","open":true,"speculative":true}]}"#;
const ON_FINALIZE: &str = r#"{"newly_committed":[{"id":3,"kind":{"type":"Table","data":{"headers":[{"text":"A","html":"A"},{"text":"B","html":"B"}],"rows":[[{"text":"1","html":"1"},{"text":"2","html":"2"}]],"aligns":[null,null]}},"start":46,"end":76,"html":"<table>\n<thead>\n<tr>\n<th>A</th>\n<th>B</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td>1</td>\n<td>2</td>\n</tr>\n</tbody>\n</table>","open":false,"speculative":false}],"active":[]}"#;

/// A [`BrookConfig`] with every setter at `StreamParser`'s *library* default
...
fn lib_default_config(block_data: bool) -> BrookConfig {
    BrookConfig {
        gfm_autolinks: false,
        gfm_alerts: false,
        gfm_tagfilter: false,
        ...
        block_data,
        wire_delta: false,
        // Appended after `wire_delta` — `BrookConfig` is a positionally-serialized
        // uniffi record, so new fields only ever land at the END of this literal.
        soft_breaks: false,
        allow_schemes: None,
        lenient_lists: false,
        block_html: false,
...
fn stream(session: &BrookSession) -> Vec<String> {
...
fn golden_wire_default_bare() {
    // Bare `new()` == `StreamParser::new()` == the wasm `new BrookParser()`.
    let got = stream(&BrookSession::new());
...
fn golden_wire_block_data() {
    let got = stream(&BrookSession::new_with_config(lib_default_config(true)));
...
fn golden_all_blocks_default() {
    let session = BrookSession::new();
    for c in CHUNKS {
        session.append(c.to_string());
    }
    session.finalize();
    assert_eq!(session.all_blocks(), OFF_ALLBLOCKS, "allBlocks wire drifted (contract v1.1.0)");
}
...
fn reset_restarts_fresh_from_zero() {
    ...
    let fresh = BrookSession::new().append("# Two\n\n".to_string());
...
fn reset_preserves_config() {
    let session = BrookSession::new_with_config(lib_default_config(true));
