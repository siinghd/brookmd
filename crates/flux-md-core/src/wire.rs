//! The pure-Rust JSON wire format shared by every consumer of `flux-md-core`.
//!
...
//! `WIRE.md`; it is currently **wire contract v1.0.0**. The serde field names
...
/// the string a native consumer forwards in place of `FluxParser.append` /
...
/// form read by `FluxParser.allBlocks` (see `WIRE.md`). `#[inline]` is required
