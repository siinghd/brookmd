...
//   Java_com_brookmdreactnative_BrookMdReactNativeModule_native{Install,Cleanup}RustCrate
#include <jni.h>
#include <jsi/jsi.h>
...
Java_com_brookmdreactnative_BrookMdReactNativeModule_nativeInstallRustCrate(
    JNIEnv *env,
    jclass type,
    jlong rtPtr,
  ...
  return brookmdreactnative::installRustCrate(*runtime, jsCallInvoker);
}

extern "C" JNIEXPORT jboolean JNICALL
Java_com_brookmdreactnative_BrookMdReactNativeModule_nativeCleanupRustCrate(
    JNIEnv *env,
    jclass type,
    jlong rtPtr) {
  auto runtime = reinterpret_cast<jsi::Runtime *>(rtPtr);
  return brookmdreactnative::cleanupRustCrate(*runtime);
}
