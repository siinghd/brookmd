...
import { mountBrookMarkdown, tailOpenBlockId, type MountHandle, type MountOptions } from "./dom";
 ...
 */
export function createTailBlockId(client: BrookClient): Accessor<number | null> {
 ...
 */
export function BrookMarkdown(props: BrookMarkdownProps): JSX.Element {
 ...
 */
export function setupBrookMarkdownString(
  getContent: () => string,
 ...
 */
export function createBrookMarkdownString(
  getContent: () => string,
