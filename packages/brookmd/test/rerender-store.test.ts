...
import { BrookClient, BrookPool, applyPatch, emptyBlockStore } from "../src/client";
...
// live BrookClient (emit/reset/subscribe) is driven over a FakeWorker through a
// BrookPool exactly as pool.test.ts / setcontent.test.ts do — no real Worker/WASM.
...
function wire(client: BrookClient, created: FakeWorker[]): { sid: number; w: FakeWorker } {
