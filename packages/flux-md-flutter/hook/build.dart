...
// (crates/flux-md-cabi via .github/workflows/cabi-build.yml), vendored into the
...
//       // 1. `cargo build --release` the flux-md-cabi crate for
...
//       //    DynamicLibrary.open (see lib/flux_md.dart).
//     });
//   }
//
