...
// JSI runtime + call-invoker to the C++ layer (cpp/flux-md-react-native.cpp),
// which registers the ubrn-generated `NativeFluxMdFfi` JSI host object on
// `globalThis`. The actual parser calls then go through JSI directly (see
// src/generated/flux_md_ffi.ts), not over the bridge.
//
// `codegenConfig.name` in package.json (`RNFluxMdReactNativeSpec`) tells RN
...
export default TurboModuleRegistry.get<Spec>("FluxMdReactNative");
